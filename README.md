...
- **[State-of-the-art weakly supervised semantic segmentation](https://github.com/HarimxChoi/wsss-refined-pseudolabels)**\
  COCO-Val mIoU 53.31%
- **[State-of-the-art ultra-low-bit LLM quantization](https://github.com/HarimxChoi/WarpQuant)**\
  CUDA kernel optimization · 7.36× decoding speed
- **[MCP search server with automatic knowledge graph construction](https://github.com/HarimxChoi/google-surf-mcp)**\
